...
void TriangleRasterizer::RecalcBounds()
{
	...
	GenerateContourBuffer(ScreenPoint(VertexBuffer[0].Position.ToVector2()), ScreenPoint(VertexBuffer[1].Position.ToVector2()));
	GenerateContourBuffer(ScreenPoint(VertexBuffer[0].Position.ToVector2()), ScreenPoint(VertexBuffer[2].Position.ToVector2()));
	GenerateContourBuffer(ScreenPoint(VertexBuffer[1].Position.ToVector2()), ScreenPoint(VertexBuffer[2].Position.ToVector2()));
